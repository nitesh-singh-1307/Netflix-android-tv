...
import com.example.netflix.ui.screen.discover.DiscoverScreen
import com.example.netflix.ui.theme.JetcasterAppDefaults

@Composable
fun NetflixApp(jetcasterAppState: JetcasterAppState = rememberJetcasterAppState()) {
